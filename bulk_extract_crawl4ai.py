...
4. もし記事が有料会員限定などで本文が取得できない場合、または本文に「ご登録で全文お読みいただけます」「2カ月無料体験」「ログインする」「会員限定記事」といった内容が含まれる場合は、どれほどリード文が長くても body_markdown を 'PAYWALL_BLOCKED' と記述してください。一部の無料公開分（ティーザー）のみを抽出してはいけません。"""
