  ...
  return (
    <main className="bg-[#020617] text-white font-sans selection:bg-blue-500/30">
      ...
      <motion.div
        ...
        style={{ scaleX: "var(--scroll-percent)" }}
      />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8">
              ...
              <span className="text-[10px] font-bold tracking-widest uppercase">Start your intelligence journey</span>
            </div>
            ...
            <Link href="/" className="inline-block">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-12 py-6 border border-white/20 rounded-full font-bold text-xl overflow-hidden hover:border-blue-500/50 transition-colors"
              >
                ...
                <div className="absolute inset-0 bg-blue-500/0 group-hover:bg-blue-500/5 blur-xl transition-all" />
              </motion.div>
            </Link>
          </motion.div>
        </div>
      ...
      {/* Simple Footer */}
      <footer className="py-12 px-4 border-t border-white/5 text-center text-gray-600 text-[10px] tracking-widest uppercase font-bold">
